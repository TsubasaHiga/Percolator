...
EOM;
        ...
        case 'FB':
            $html = <<< EOM
            <a class="{$class}" href="https://www.facebook.com/dialog/share?app_id={$FB_APPID}&display=popup&href={$pageurl}&redirect_uri={$pageurl}" target="_blank" rel="noopener" aria-label="facebook">facebook</a>
EOM;
            return $html;
            break;
        ...
        case 'HB':
            $html = <<< EOM
            <a class="{$class}" href="http://b.hatena.ne.jp/add?mode=confirm&url={$pageurl}" target="_blank" rel="noopener" aria-label="hatena">hatena</a>
EOM;
            return $html;
            break;
        ...
        case 'LN':
            $html = <<< EOM
            <a class="{$class}" href="http://line.me/R/msg/text/?{$title};url={$pageurl}" target="_blank" rel="noopener" aria-label="line">line</a>
EOM;
            return $html;
            break;
        ...
        case 'PK':
            $html = <<< EOM
            <a class="{$class}" href="http://getpocket.com/edit?url={$title};url={$pageurl}" target="_blank" rel="noopener" aria-label="pocket">pocket</a>
EOM;
            return $html;
            break;
    }
